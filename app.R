...
#Import Data
vaers.sub.df <- read.csv("cave-sub-11-26-2021.csv")
vaers.sub.df$VAX_DATE_R <- as.Date(vaers.sub.df$VAX_DATE, "%m/%d/%Y")
vaers.grp.df <- read.csv("cave-grp-11-26-2021.csv")
vaers.died.df <- read.csv("cave-died-11-26-2021.csv")
             ...
             tabPanel("Search", fluid = TRUE, icon = icon("search"),
                      ...
                      sidebarLayout(
                        sidebarPanel(
                          ...
                          HTML("<iframe id='kofiframe' src='https://ko-fi.com/jasonmorphett/?hidefeed=true&widget=true&embed=true&preview=true' style='border:none;width:100%;padding:10px;background:#ffffff;' height='712' title='jasonmorphett'></iframe>"),
                        ...
                        tabPanel("About", fluid = TRUE,
                                 fluidRow(
                                   column(6,
                                          ...
                                          h5(p("I hope you find it interesting, helpful and/or useful.  Any comments or questions are welcome at uea15577@gmail.com"),
                                             p("If you'd like to help out, why not ", a("buy me a coffee", href = "https://ko-fi.com/jasonmorphett", target="_blank"), ". Thanks", icon("coffee", style = "color: light-gray"))),
                                          br(),
                                   ...
                                   column(6,
                                          ...
                                          h5(p("Jason Morphett is a former Principal Analyst with a FTSE 100 company in the UK. Before leaving the corporate environment, he worked on multi-million pound investment programs and specialised in data visualisation and analytics."),
                                             p("Jason is a named inventor on " , a("10 patents", href = "https://patents.justia.com/inventor/jason-morphett"), " and holds a PhD in Computer Science from the University of Nottingham in the UK. He is also a former Chartered Engineer and Member of the Institute of Engineering and Technology in London."),
                                             p("When not writing software, Jason enjoys being outdoors in the hills and spending time with family and nature"),
